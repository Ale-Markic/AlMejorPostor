...
public class OfertaTest {
	...
	public void happyPathOfertaNoArrojaError() {
		Oferta oferta = new Oferta(fecha ,"Alejandro" , 7, 10, 15000);
	...
	public void nombreVacioArrojaError() {
		Oferta oferta = new Oferta(fecha,"", 4, 7, 10000);
	}
	...
	public void ingresarMontoIgualACeroArrojaError() {
		Oferta oferta = new Oferta(fecha,"Alejandro" , 7, 10, 0);
	}
	...
	public void ingresarHoraInicioAltaArrojaError() {
		Oferta oferta = new Oferta(fecha,"Alejandro" ,25, 10, 15000);
	}
	
	@Test(expected = RuntimeException.class)
	public void ingresarHoraFinAltaArrojaError() {
		Oferta oferta = new Oferta(fecha, "Alejandro" , 7, 25, 15000);
	}
	
	@Test(expected = RuntimeException.class)
	public void ingresarHorasIgualesArrojaError() {
		Oferta oferta = new Oferta(fecha, "Alejandro" , 7, 7, 15000);
	}
	
	@Test
	public void ingresoHoraInicioLimiteBajo() {
		Oferta oferta = new Oferta(fecha, "Alejandro" , 0, 7, 15000);
	...
	public void ingresoHoraFinLimiteBajo() {
		...
		Oferta oferta = new Oferta(fecha, "Alejandro" , 0, 0, 15000);
	}
	...
	public void ingresoHoraInicioLimiteAlto() {
		...
		Oferta oferta = new Oferta(fecha, "Alejandro" , 24, 24, 15000);
	}
	
	@Test
	public void ingresoHoraFinLimiteAlto() {
		Oferta oferta = new Oferta(fecha, "Alejandro", 3, 24, 15000);
	...
	public void obtenerLaDuracionFuncionaBien() {
		Oferta oferta = new Oferta (fecha, "Matias", 3, 17, 50000);
